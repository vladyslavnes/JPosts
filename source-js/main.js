...
$('.btn.addNewArticle').click(function() {
	...
	$('input#newArticleTitle').val('')
	$('textarea#newArticleText').val('').css('height','0')
	$('input#newArticleImage').val('')
})
